...
var RootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		r.report, err = reporter.New(
			...
			reporter.MetricToCSV(collector.Mem.YoungPoolUsedBytes, csvFilePath("mem.young.used.bytes", expID, resultsPath)),
			reporter.MetricToCSV(collector.Mem.YoungPoolMaxBytes, csvFilePath("mem.young.max.bytes", expID, resultsPath)),
			reporter.MetricToCSV(collector.Mem.TenuredPoolUsedBytes, csvFilePath("mem.tenured.used.bytes", expID, resultsPath)),
			reporter.MetricToCSV(collector.Mem.TenuredPoolMaxBytes, csvFilePath("mem.tenured.max.bytes", expID, resultsPath)),
			reporter.MetricToCSV(collector.Mem.SurvivorPoolUsedBytes, csvFilePath("mem.survivor.used.bytes", expID, resultsPath)),
			reporter.MetricToCSV(collector.Mem.SurvivorPoolMaxBytes, csvFilePath("mem.survivor.max.bytes", expID, resultsPath)),
